    ...
    <Document>
      <Page size="A4" style={styles.page}>
        <Text style={styles.header}>
          Видаткова накладна № {order.number} від{' '}
        ...
        <View style={styles.section}>
          <View style={styles.row}>
            ...
            <View>
              ...
              <Text style={styles.text}>
                п/р UA 8223200100002600340017527 у банку АТ "УНІВЕРСАЛ БАНК",
                МФО 322001,
              </Text>
              <Text style={styles.text}>
          ...
          <View style={styles.row}>
            <Text style={styles.label}>Розр. док.: </Text>
            <View>
              <Text style={styles.text}>
                Замовлення № {order.number} від{' '}
          ...
          <View style={styles.row}>
            ...
            <View>
              <Text style={styles.text}>Головний склад №1</Text>
            </View>
          </View>
        </View>
